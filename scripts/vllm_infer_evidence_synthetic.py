...
def build_step1_prompt(input_text):
    f_extract_prompt = """
Instruction: Carefully read the following input and list all important entities mentioned, in the format below.
- Output entities as a comma-separated English list. No extra words.

Example:
Input: The patient reports experiencing a persistent Blue Map and Rubber Escalator for three days. Chest X-ray was performed with no abnormalities detected.
Output: Blue Map, Rubber Escalator, Chest X-ray
...
Example:
Entities: Blue Map, Wooden Sky, Mirror Flower
Output: 
(Blue Map, Rubber Escalator), (Blue Map, Map), (Blue Map,  Blue)
(Wooden Sky, Mirror Flower), (Wooden Sky, Sky), (Wooden Sky, Wooden)
...
Example 1:
Question: The patient's main complaint during this visit is Blue Map, which can sometimes indicate Rubber Escalator, although no clinical or laboratory abnormalities related to Rubber Escalator have been found. Does Rubber Escalator exist or hold?
Note: Blue Map and Rubber Escalator may not necessarily be related. Please carefully examine the original text and make a thorough judgment.
Answer: 【Conclusion】No.
"", "B": "Mirror Flower"
Example 2:
Question: The patient has been experiencing persistent Wooden Sky for several days, which can sometimes suggest Mirror Flower; imaging results showed clear lungs with signs of Mirror Flower. Does Mirror Flower exist or hold?
Note: Wooden Sky and Mirror Flower may not necessarily be related. Please carefully examine the original text and make a thorough judgment.
